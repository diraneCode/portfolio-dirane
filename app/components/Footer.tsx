    ...
    <footer className="py-6">
      <div className="mx-auto max-w-5xl px-6">
        <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          {/* X / Twitter */}
          <a
            href="https://twitter.com/@dirane_joker"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="X / Twitter"
            className="text-muted-foreground transition-colors duration-300 hover:text-[#1DA1F2]"
          >
            <svg
              className="size-6"
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/dirane-mekem-63b588273"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-muted-foreground transition-colors duration-300 hover:text-[#0077B5]"
          >
            <svg
              className="size-6"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Facebook */}
          <a
            href="https://facebook.com/diranemekem"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="text-muted-foreground transition-colors duration-300 hover:text-[#1877F2]"
          >
            <svg
              className="size-6"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Threads */}
          <a
            href="https://www.threads.net/@diranecode33"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Threads"
            className="text-muted-foreground transition-colors duration-300 hover:text-black dark:hover:text-white"
          >
            <svg
              className="size-6"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Instagram */}
          <a
            href="https://instagram.com/diranecode33"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram"
            className="text-muted-foreground transition-colors duration-300 hover:text-[#E4405F]"
          >
            <svg
              className="size-6"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="text-muted-foreground transition-colors duration-300 hover:text-[#000000] dark:hover:text-[#69C9D0]"
          >
            <svg
              className="size-6"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <span className="text-muted-foreground block text-center text-sm">
          © Septembre {new Date().getFullYear()} — Designed & Developed by{" "}
          <a
