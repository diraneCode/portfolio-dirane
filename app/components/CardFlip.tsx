...
export default function CardFlip({
    ...
    return (
        <div
            className="group relative h-[360px] w-full max-w-[300px] [perspective:2000px] dark"
                    ...
                    <div className="relative z-10 mt-auto border-t border-slate-200 pt-4 dark:border-zinc-800">
                        <Link href="/#CVSection"
                            className={cn(
                                ...
                                'bg-[#4169e1] from-slate-100 via-slate-100 to-slate-100',
                            ...
                            <div className="group/icon relative">
                                <div
                                    className={cn(
                                        ...
                                        'from-primary/20 via-primary/10 bg-black/30 to-transparent',
