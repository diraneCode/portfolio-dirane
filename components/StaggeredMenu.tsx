...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (overlay) {
      tl.to(overlay, { opacity: 1, pointerEvents: "auto", duration: 0.3, ease: "power2.out" }, panelInsertTime)
    }
...
.sm-scope .sm-socials-title { margin: 0; font-size: 1rem; font-weight: 500; color: var(--sm-accent, #4169e1); }
